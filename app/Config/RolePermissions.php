...
return [
    ...
    'MODERATOR' => ['/kasir', '/histori-transaksi', '/rekapitulasi', '/profile', '/change-password', '/logout', '/kasir/konfirmasi/id/([0-9a-zA-Z-]*)', '/kasir/recap', '/kasir/cetak/id/([0-9a-zA-Z-]*)'], //kasir
